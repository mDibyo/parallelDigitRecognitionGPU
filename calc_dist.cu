...
__global__ void distance4096NormalFlippedKernel(float* gpuImage, float* gpuTemp, float* gpuResult,
																				 int offX, int offY, int iWidth) {
	float distance
...
__global__ void distance4096ReversedKernel(float* gpuImage, float* gpuTemp, float* gpuResult,
...
__global__ void distance4096ReversedFlippedKernel(float* gpuImage, float* gpuTemp, float* gpuResult,
																					 int offX, int offY, int iWidth, int tempSize) {
	float distance
